...
import { aws_apigateway as ApiGateway, aws_s3 as s3 } from "aws-cdk-lib";
...
export class AppStack extends Stack {
  ...
  private createBackend() {
    const api = new ApiGateway.RestApi(this, "crs-api", {
      restApiName: "Kursanfragen API",
      description:
        "Zwergenstube Kursanfragen werden hier zu Emails weitergeleitet.",
